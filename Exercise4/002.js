function soal2(param)
{
    if (param.length >= 3) {
        if (param.length % 2 === 0) {
            param[param.length / 2] = param[0] * param[param.length - 1];
            param[param.length / 2 - 1] = param[0] * param[param.length - 1];
        } else {
            param[(param.length - 1) / 2] = param[0] * param[param.length - 1];
        }
    } else {
